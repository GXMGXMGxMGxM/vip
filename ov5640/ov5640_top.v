...
(
    ...
    .addr_num    (BYTE_CTRL     ),   //输入i2c寄存器地址字节数,高电平表示寄存器地址为16位,低电平表示寄存器地址为8位
    .byte_addr   (cfg_data[23:8]),   //输入i2c寄存器地址
    .wr_data     (cfg_data[7:0] ),   //输入i2c寄存器数据
